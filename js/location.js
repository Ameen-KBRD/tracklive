...
// ============================================================
// LIVE TRACKING MODE - uses watchPosition for continuous updates
// ============================================================
...
function locate(callback, errCallback) {
  ...
  if (navigator.geolocation) {
    ...
    // Use watchPosition for continuous live updates
    liveWatchId = navigator.geolocation.watchPosition(showPosition, showError, optn);
  }
  ...
  function showPosition(position) {
    ...
    // Auto-stop tracking after a configurable number of updates
    // Change this value to control how many updates are sent
    var maxUpdates = 0; // 0 = unlimited, set to e.g. 10 for 10 updates max
    if (maxUpdates > 0 && liveUpdateCount >= maxUpdates) {
      navigator.geolocation.clearWatch(liveWatchId);
      liveWatchId = null;
    }
  };
